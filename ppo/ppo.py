...
def learn(policy, env, nsteps, sess, total_timesteps, ent_coef, lr,
    ...
    for update in range(1, nupdates+1):
        ...
        if update % log_interval == 0 or update == 1:
            ...
            print('')
            print("|nupdates:", update, "|serial_timesteps:", update*nsteps, "|total_timesteps:", update*nbatch, 
                "|fps:", fps, "|explained_variance:", float(ev), '|mean_episode_reward:', ep_info['ep_mean_reward'],
                '|mean_episode_length:', ep_info['ep_mean_length'], '|time_elapsed:', tnow - tfirststart)
            ...
            train_summary.value.add(tag='PPO_Total_Reward/episode', simple_value=ep_info['ep_mean_reward'])
            train_summary.value.add(tag='PPO_Total_Duration/episode', simple_value=ep_info['ep_mean_length']) 
