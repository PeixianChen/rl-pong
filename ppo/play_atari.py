import sys
sys.path.append('/home/sugon/Peixian/rl-experiments/')
import time
import os
import argparse
        ...
        for _ in range(100):
            ...
            while True:
                ...
                if dones:
                    ...
                    #f.write ("score:" + str(total_reward) + " " + str(steps) + "\n")
                    if total_reward > 0: win += 1
                    # time.sleep(5)
...
def main():
    ...
    parser.add_argument('--model-path', help='model path', default='../model/ppo/')
    parser.add_argument('--video', help='enable video recording', action='store_true', default=False)
